...
interface LayoutShellProps {
  ...
  children: ReactNode;
  theme?: "light" | "dark";
  /** Override main content area background (e.g. "bg-transparent" for resident dashboard gradient) */
...
export const LayoutShell: React.FC<LayoutShellProps> = ({
  ...
  return (
    ...
    >
      {/* Desktop sidebar: visible from lg */}
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
            <button
              ...
              className={`lg:hidden p-2 -ml-2 rounded-lg focus:outline-none focus:ring-2 ${
                isResident ? "hover:bg-white/10 focus:ring-violet-400/50 text-white" : "hover:bg-slate-200/50 focus:ring-teal-400/50"
              }`}
            >
